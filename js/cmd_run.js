...
var cmd_result_dict={/* 反斜杠用于多行字符串 */
	"help":"<table>\
				...
				<tbody>\
					<tr><td class='cmd_name'>help</td><td>show the menu (command manual) of the site</td></tr>\
					<tr><td class='cmd_name'>lib</td><td>visit Isaac's personal library (chinese)</td></tr>\
					<tr><td class='cmd_name'>old</td><td>visit Isaac's old-version site (chinese)</td></tr>\
					<tr><td class='cmd_name'>asoul</td><td>know more about Isaac's favorite idols</td></tr>\
				</tbody>\
			</table>",
	"asoul":"<p>A-SOUL is a Virtual Idol group produced by Yuehua Entertainment. \
			...
			",
	"guide":"<p>This page adopts command-style design. Any interaction with this page can be done by commands.<br/><br/>\
			<b>How to use?</b><br/>\
			Click (tap) the area which reads 'Type commands here..'.<br/>\
			Type valid commands and Press 'Enter' on your device.<br/><br/>\
			<b>Still don't know?</b><a href='no_cmd.html'>Visit the page without commands typing.</a>\
			</p>"
}
